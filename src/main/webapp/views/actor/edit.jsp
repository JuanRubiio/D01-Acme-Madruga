...
<form:form action="profile/edit.do" modelAttribute="actor" method="post">
...
<jstl:if test="${readonly == false }">
	...
	<input type="button" name="cancel"
		...
		onclick="javascript: relativeRedir('profile.do');" />
	<br />
	...
	<input type="button" name="edit"
		...
		onclick="javascript: relativeRedir('profile/edit.do');" />
